...
def load_examples():
    ...
    with tf.name_scope("target_images"):
        ...
        # ----------------------------------2018.1.18 changed by zyt--------------------------------
        # get the center 256*256 of image(512*512)
        target_images = target_images[128:384, 128:384, :]
...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    with tf.variable_scope("decoder_1"):
        # ----------------------------------2018.1.18 changed by zyt--------------------------------
        input = tf.concat([layers[-1], layers[0][:, 64:192, 64:192, :]], axis=3)
        rectified = tf.nn.relu(input)
...
def create_model(inputs, targets):
    def create_discriminator(discrim_inputs, discrim_targets):
        ...
        # ----------------------------------2018.1.18 changed by zyt--------------------------------
        # get the center 256*256 of image(512*512)
        discrim_inputs = discrim_inputs[:, 128:384, 128:384, :]
...
def main():
    ...
    with tf.name_scope("convert_inputs"):
        ...
        # get the center 256*256 of image(512*512)
        converted_inputs = converted_inputs[:, 128:384, 128:384, :]
